...
from bi_lstm_crf import BLSTM_CRF
import tf_metrics

flags = tf.flags
FLAGS = flags.FLAGS
bert_path = 'D:/NLP/data/chinese_L-12_H-768_A-12'
root_path = 'D:/NLP/NLP_projects/name_entity_recognition/BERT_NER'

flags.DEFINE_string("data_dir", os.path.join(root_path, 'data'),
                    "The input datadir.",)
...
flags.DEFINE_string("output_dir", os.path.join(root_path, 'output'),
                    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string("init_checkpoint", os.path.join(root_path, 'bert_model.ckpt'),
...
class DataProcessor(object):
    ...
    def _read_data(cls, input_file):
        """A read function for specific task"""
