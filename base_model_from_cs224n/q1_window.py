...
class WindowModel(NERModel):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(embedding, shape=[-1, Config.n_window_features*Config.embed_size])
        ### END YOUR CODE
        return embeddings
    ...
    def add_loss_op(self, pred):
        ...
        entropy = tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.labels_placeholder,
                                                                 logits=pred)
